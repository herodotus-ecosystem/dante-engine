...
package cn.herodotus.engine.message.information.configuration;
...
public class InformationConfiguration {
    ...
    private static final Logger log = LoggerFactory.getLogger(InformationConfiguration.class);

    @PostConstruct
    public void postConstruct() {
        log.debug("[Herodotus] |- SDK [Message Exchange] Auto Configure.");
    }
}
