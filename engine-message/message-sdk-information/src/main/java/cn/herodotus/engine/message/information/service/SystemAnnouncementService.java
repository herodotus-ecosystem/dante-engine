...
public class SystemAnnouncementService extends BaseLayeredService<SystemAnnouncement, String> {
    ...
    public List<SystemAnnouncement> pullAnnouncements(Date stamp) {
        List<SystemAnnouncement> systemAnnouncements = systemAnnouncementRepository.findAllByCreateTimeAfter(stamp);
