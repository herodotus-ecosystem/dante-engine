 ...
 */
public interface SystemAnnouncementRepository extends BaseRepository<SystemAnnouncement, String> {

    @QueryHints(@QueryHint(name = AvailableHints.HINT_CACHEABLE, value = "true"))
    List<SystemAnnouncement> findAllByCreateTimeAfter(Date stamp);
}
