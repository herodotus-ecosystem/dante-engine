 ...
 */
public interface NotificationQueueRepository extends BaseRepository<NotificationQueue, String> {

    @QueryHints(@QueryHint(name = AvailableHints.HINT_CACHEABLE, value = "true"))
    List<NotificationQueue> findAllByUserIdAndRead(String userId, Boolean isRead);
}
