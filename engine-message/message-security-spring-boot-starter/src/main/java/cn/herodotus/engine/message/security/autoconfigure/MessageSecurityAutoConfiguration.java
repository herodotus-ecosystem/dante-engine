...
package cn.herodotus.engine.message.security.autoconfigure;
...
@RemoteApplicationEventScan({
        "cn.herodotus.engine.message.security.autoconfigure.event"
})
public class MessageSecurityAutoConfiguration {
    ...
    public void postConstruct() {
        log.info("[Herodotus] |- Module [Message Security Starter] Auto Configure.");
    }
}
