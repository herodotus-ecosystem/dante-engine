...
public class HerodotusHttpSessionListener implements HttpSessionListener {
    ...
    public void sessionCreated(HttpSessionEvent httpSessionEvent) {
        ...
        log.debug("[Herodotus] |- The session is created, session id is [{}]", httpSession.getId());
    }
    ...
    public void sessionDestroyed(HttpSessionEvent httpSessionEvent) {
        ...
        log.debug("[Herodotus] |- The session is destroyed, session id is [{}]", httpSession.getId());
    }
}
