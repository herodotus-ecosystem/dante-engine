 ...
 */
public class OAuth2ApplicationToEntityConverter implements Converter<OAuth2ApplicationDto, OAuth2Application> {
    @Override
    public OAuth2Application convert(OAuth2ApplicationDto dto) {
