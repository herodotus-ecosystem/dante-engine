 ...
 */
public class OAuth2ApplicationToDtoConverter implements Converter<OAuth2Application, OAuth2ApplicationDto> {
    @Override
    public OAuth2ApplicationDto convert(OAuth2Application entity) {
