 ...
 * @date : 2023/9/1 11:33
 */
public class OAuth2AuthorizationCodeAuthenticationProviderCustomizer implements Consumer<List<AuthenticationProvider>> {

    private static final Logger log = LoggerFactory.getLogger(OAuth2AuthorizationCodeAuthenticationProviderCustomizer.class);

    private final HttpSecurity httpSecurity;
    private final SessionRegistry sessionRegistry;

    public OAuth2AuthorizationCodeAuthenticationProviderCustomizer(HttpSecurity httpSecurity, SessionRegistry sessionRegistry) {
