 ...
 * @date : 2023/3/7 11:03
 */
public class SysInterfaceUuidGenerator extends AbstractUuidGenerator {

    public SysInterfaceUuidGenerator(SysInterfaceUuid config, Member idMember, CustomIdGeneratorCreationContext creationContext) {
        super(idMember);
    }
