 ...
 * @date : 2021/8/4 3:20
 */
public class SysAttributeUuidGenerator extends AbstractUuidGenerator {

    public SysAttributeUuidGenerator(SysAttributeUuid config, Member idMember, CustomIdGeneratorCreationContext creationContext) {
        super(idMember);
    }
