...
package cn.herodotus.stirrup.access.all.configuration;

import cn.herodotus.stirrup.access.all.controller.JustAuthAccessController;
import cn.herodotus.stirrup.access.all.controller.PhoneNumberAccessController;
import cn.herodotus.stirrup.access.all.controller.WxappAccessController;
import cn.herodotus.stirrup.access.all.processor.AccessHandlerStrategyFactory;
import cn.herodotus.stirrup.access.justauth.annotation.ConditionalOnJustAuthEnabled;
import cn.herodotus.stirrup.access.justauth.configuration.AccessJustAuthConfiguration;
import cn.herodotus.stirrup.access.sms.annotation.ConditionalOnSmsEnabled;
import cn.herodotus.stirrup.access.sms.configuration.AccessSmsConfiguration;
...
import cn.herodotus.stirrup.access.wxapp.configuration.AccessWxappConfiguration;
import cn.herodotus.stirrup.access.wxmpp.configuration.AccessWxmppConfiguration;
