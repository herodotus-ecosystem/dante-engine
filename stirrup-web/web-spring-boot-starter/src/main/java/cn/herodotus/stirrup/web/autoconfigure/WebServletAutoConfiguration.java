...
public class WebServletAutoConfiguration implements WebMvcConfigurer {
    ...
    public WebServletAutoConfiguration(IdempotentInterceptor idempotentInterceptor, AccessLimitedInterceptor accessLimitedInterceptor, MultiTenantInterceptor multiTenantInterceptor) {
    ...
    public void postConstruct() {
        log.debug("[Herodotus] |- Module [Web Servlet] Auto Configure.");
    }
