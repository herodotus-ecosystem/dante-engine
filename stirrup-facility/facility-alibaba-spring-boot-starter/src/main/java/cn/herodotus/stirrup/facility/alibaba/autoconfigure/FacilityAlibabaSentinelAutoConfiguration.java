...
package cn.herodotus.stirrup.facility.alibaba.autoconfigure;
...
/**
 * <p>Description: Spring Cloud Alibaba Sentinel 自动配置 </p>
 *
...
public class FacilityAlibabaSentinelAutoConfiguration {
    ...
    public void postConstruct() {
        log.debug("[Herodotus] |- Module [Facility Alibaba Sentinel] Auto Configure.");
    }
