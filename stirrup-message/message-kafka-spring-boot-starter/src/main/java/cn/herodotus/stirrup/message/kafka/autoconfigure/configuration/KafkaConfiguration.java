...
package cn.herodotus.stirrup.message.kafka.autoconfigure.configuration;

import cn.herodotus.stirrup.message.kafka.autoconfigure.annotation.ConditionalOnKafkaEnabled;
import cn.herodotus.stirrup.message.kafka.autoconfigure.properties.KafkaProperties;
